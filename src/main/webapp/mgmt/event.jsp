...
<body>
	...
	<div class=" container pagecontent">
        ...
        <form class="aform" id="event-form" method="post" action="evadd.jsp">
            ...
            <input type="file" placeholder="Media" required name="eimage">
            <textarea placeholder="Discription" rows="5" name="edesc" required></textarea>
            <input type="text" placeholder="Place" required name="eplace">
            <input type="text" placeholder="Organiser" required name="eorg">
  ...
  <tbody>
  	...
  	<tr>	<td><%= eid %></td>
            ...
            <td>
            <button class="Updateaction" ><a href='updateEvent.jsp?eid=<%= eid %>' > Update </a></button>
            <button class="Deleteaction"><a href='deleteEvent.jsp?eid=<%= eid %>' >Delete</a></button> 
